...
/**
 * Servlet implementation class ISST_VIAJES_AprobarJustificantes_Servlet
 */
public class ISST_VIAJES_AprobarJustificantes_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ISST_VIAJES_AprobarJustificantes_Servlet() {
        super();
