	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (viaje != null){
			...
			try {
				...
				msg.setSubject("El responsable " + nombreSupervisorViaje + " ha denegado la solicitud de tu viaje");
				msg.setText("El responsable " + nombreSupervisorViaje + " del proyecto "+ nombreProyecto +" ha denegado tu solicitud de viaje a " + destinoViaje + " por el motivo: " + motivoDenegacion);
				Transport.send(msg);
