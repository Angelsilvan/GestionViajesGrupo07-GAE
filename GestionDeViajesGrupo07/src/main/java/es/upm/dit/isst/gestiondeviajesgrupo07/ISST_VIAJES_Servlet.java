...
//			Prueba empleados y proyectos.
			EMPLEADO angel = dao.createEMPLEADO(3, "angel", "silvan", "camina");
			EMPLEADO pepe = dao.createEMPLEADO(1, "Pepe", "Granja", "Garcia");
			EMPLEADO jaime = dao.createEMPLEADO(2, "jaime", "palos", "pereira");
			ArrayList<EMPLEADO> empleados = new ArrayList<>();
			empleados.add(pepe);
			empleados.add(angel);
			PROYECTO proyecto1 = dao.createPROYECTO("AREA51", empleados, jaime, "Madrid", "ISST");
//			//Viaje
//			VIAJE viaje = dao.createViaje(1, alejandro, "18 Junio", "28 Junio", proyecto1, 1, "Chicago", "Estados Unidos", "Illinois", "presentacion");
//			
